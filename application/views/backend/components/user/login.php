<html lang="">
    ...
    <body>
        <div class="container khung">
            <div class="title">
                <h2 class="text-center" ><img src="<?php echo base_url() ?>public/images/coollogo_com-1752611.png" alt="Green Construction"></h2>
            </div>
            <hr>
            <div class="myform">
        ...
        <nav class="navbar navbar-fixed-bottom" role="navigation">
            <div class="container">
               <h5 class="text-center">Copyright © 2017 <a href="https://www.facebook.com/hoa.nguyenvan.4" style="color:red">Hòa Nguyễn</a>. All rights reserved.</h5>
            </div>
        </nav>
        <!-- jQuery -->
