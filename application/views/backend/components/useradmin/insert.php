                        ...
                        <div class="box-body">
                            ...
                            <?php //echo validation_errors(); ?>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fullname" value="<?php echo set_value('fullname') ?>" style="width:100%">
                                    <div class="error" id="password_error"><?php echo form_error('fullname')?></div>
                                </div>
                                <div class="form-group">
                                    <label>Điện thoại <span class = "maudo">(*)</span></label>
                                    <input type="text" class="form-control" value="<?php echo set_value('phone') ?>" name="phone" style="width:100%">
                                    <div class="error" id="password_error"><?php echo form_error('phone')?></div>
                                </div>
                                <div class="form-group">
                                    <label>Email <span class = "maudo">(*)</span></label>
                                    <input type="email" class="form-control" value="<?php echo set_value('email') ?>" name="email" style="width:100%">
                                    <div class="error" id="password_error"><?php echo form_error('email')?></div>
                                </div>
                                <div class="form-group">
                                    <label>Tên đăng nhập <span class = "maudo">(*)</span></label>
                                    <input type="text" class="form-control" value="<?php echo set_value('username') ?>" name="username" style="width:100%">
                            ...
                            <div class="col-md-3" style="padding: 0px">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file"  id="image_list" value="<?php echo set_value('img') ?>" name="img" required style="width: 100%">
                                </div>
                                <div class="form-group">
