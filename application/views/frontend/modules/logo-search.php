...
<div class="container">
	<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 logo">
		<a href="<?php echo base_url() ?>"><img src="<?php echo base_url() ?>public/images/coollogo_com-18298486.gif" alt="Green Construction"></a>
	</div>
	...
	<div class="col-md-2 cart hidden-xs hidden-sm" style="left: 5px">
		<a href="gio-hang">
