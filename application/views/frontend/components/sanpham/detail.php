					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="product-view-content">
							...
							<div class="product-status">
								...
								<p>| Tình trạng: <?php if($row['number']==0) echo 'Hết hàng'; else echo 'Còn hàng' ?></p><p>Lượt xem: <?php echo $row['view'] ?></p>
							</div>
							...
							<?php foreach ($sm_products as $row) :?>
								<div class="item col-md-2 col-sm-2 col-xs-6 product-one">
									...
									<div class="btn-action">
										<button type="button" class="fa fa-shopping-cart" data-toggle="modal" data-target="#myModal"></button>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" onclick="onAddCart(<?php echo $row['id']  ?>)">OK</button>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
</div><!-- /.modal -->
	...
	function onAddCart(id){
		...
		jQuery.ajax({
			...
			success: function(data) {
                ...
                window.location.assign('http://localhost/php1702lm/gio-hang');
            }
        });
	}
</script>
