...
class Giohang extends CI_Controller {
    ...
    public function info_order(){
        ...
        if($this->form_validation->run() == TRUE){
            ...
            // $config['smtp_user']    = 'kauboy9xtiti@gmail.com';
            // $config['smtp_pass']    = '14111995';
            ...
            // $this->email->from('hoacntt.hpu2@gmail.com', 'HoaLoanStore');
            // $list = array('hoacntt.hpu2@gmail.com');//Mặc định là email của admin
            // $this->email->to($list);
            // $this->email->subject('Hệ thống HoaLoanStore');
