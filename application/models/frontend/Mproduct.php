...
class Mproduct extends CI_Model {
    ...
    public function pro_update($mydata1, $id1)
        {
                $this->db->where('id',$id1);
                $this->db->update($this->table, $mydata1);
        }
    ...
    public function product_view_max($limit)
    {
        $this->db->where('status', 1);
        $this->db->where('trash', 1);
    ...
    public function product_purchase_max($limit)
    {
        $this->db->where('status', 1);
        $this->db->where('trash', 1);
